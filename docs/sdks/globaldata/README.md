...
<!-- UsageSnippet language="typescript" operationID="v3-globaldata-asset-certificate-list-raw" method="get" path="/v3/global/asset/certificate/raw" -->
```typescript
import { SDK } from "@censys/platform-sdk";
...
**Promise\<[operations.V3GlobaldataAssetCertificateListRawResponse](../../models/operations/v3globaldataassetcertificatelistrawresponse.md)\>**
