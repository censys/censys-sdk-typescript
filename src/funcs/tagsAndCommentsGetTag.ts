 ...
 */
export function tagsAndCommentsGetTag(
  client: SDKCore,
  request: operations.V3TagsGetTagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsGetTagResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3TagsGetTagRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsGetTagResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
