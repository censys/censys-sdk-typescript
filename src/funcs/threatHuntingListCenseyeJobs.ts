 ...
 */
export function threatHuntingListCenseyeJobs(
  client: SDKCore,
  request: operations.V3ThreathuntingCenseyeJobsListRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3ThreathuntingCenseyeJobsListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ThreathuntingCenseyeJobsListRequest$outboundSchema.parse(
        value,
      ),
  ...
  const query = encodeFormQuery({
    ...
    "webproperty_id": payload.webproperty_id,
  }, { explode: false });
  ...
  >(
    M.json(
      200,
      operations.V3ThreathuntingCenseyeJobsListResponse$inboundSchema,
      { hdrs: true, key: "Result" },
    ),
    M.jsonErr(401, errors.AuthenticationError$inboundSchema),
    M.jsonErr([400, 403, 409], errors.ErrorModel$inboundSchema, {
