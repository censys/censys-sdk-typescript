...
export function globalDataGetHostTimeline(
  ...
  Result<
    operations.V3GlobaldataAssetHostTimelineResponse,
    | errors.ErrorModel
    | SDKBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataAssetHostTimelineRequest$outboundSchema.parse(
        value,
      ),
  ...
  const headers = new Headers(compactMap({
    Accept: "application/vnd.censys.api.v3.host_timeline_event.v1+json",
  }));
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataAssetHostTimelineResponse$inboundSchema,
      {
        ctype: "application/vnd.censys.api.v3.host_timeline_event.v1+json",
        hdrs: true,
        key: "Result",
      },
    ),
