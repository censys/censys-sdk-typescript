...
export function globalDataGetCertificatesRaw(
  ...
  Result<
    operations.V3GlobaldataAssetCertificateListRawResponse,
    | errors.ErrorModel
    | SDKBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataAssetCertificateListRawRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataAssetCertificateListRawResponse$inboundSchema,
