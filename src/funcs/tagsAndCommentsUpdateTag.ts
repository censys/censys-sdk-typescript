 ...
 */
export function tagsAndCommentsUpdateTag(
  client: SDKCore,
  request: operations.V3TagsUpdateTagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsUpdateTagResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3TagsUpdateTagRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateTagInputBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsUpdateTagResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
