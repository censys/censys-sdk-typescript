 ...
 */
export function collectionsAggregate(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CollectionsSearchAggregateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3CollectionsSearchAggregateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
