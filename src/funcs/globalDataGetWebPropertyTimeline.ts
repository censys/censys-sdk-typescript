 ...
 */
export function globalDataGetWebPropertyTimeline(
  client: SDKCore,
  request: operations.V3GlobaldataAssetWebpropertyTimelineRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3GlobaldataAssetWebpropertyTimelineResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataAssetWebpropertyTimelineRequest$outboundSchema
        .parse(value),
  ...
  const pathParams = {
    webproperty_id: encodeSimple("webproperty_id", payload.webproperty_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc(
    "/v3/global/asset/webproperty/{webproperty_id}/timeline",
  )(pathParams);
  ...
  const headers = new Headers(compactMap({
    Accept: "application/vnd.censys.api.v3.web_timeline_event.v1+json",
  }));
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataAssetWebpropertyTimelineResponse$inboundSchema,
      {
        ctype: "application/vnd.censys.api.v3.web_timeline_event.v1+json",
        hdrs: true,
        key: "Result",
      },
    ),
