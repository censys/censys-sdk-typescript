...
export function collectionsUpdate(
  ...
  Result<
    operations.V3CollectionsCrudUpdateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CollectionsCrudUpdateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CrudUpdateInputBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3CollectionsCrudUpdateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
