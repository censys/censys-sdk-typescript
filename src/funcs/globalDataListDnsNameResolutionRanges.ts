...
export function globalDataListDnsNameResolutionRanges(
  ...
  Result<
    operations.V3GlobaldataDnsNameResolutionRangesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataDnsNameResolutionRangesRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v3/global/dns/resolutions/{name}/ranges")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataDnsNameResolutionRangesResponse$inboundSchema,
