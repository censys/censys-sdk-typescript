 ...
 */
export function tagsAndCommentsCreateTagAssignment(
  client: SDKCore,
  request: operations.V3TagsCreateAssignmentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsCreateAssignmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3TagsCreateAssignmentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateTagAssignmentInputBody, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v3/tags/{tag_id}/assignments")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.V3TagsCreateAssignmentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
