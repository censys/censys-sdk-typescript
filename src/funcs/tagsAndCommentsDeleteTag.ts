...
export enum DeleteTagAcceptEnum {
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3TagsDeleteTagRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/tags/{tag_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3TagsDeleteTagResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
