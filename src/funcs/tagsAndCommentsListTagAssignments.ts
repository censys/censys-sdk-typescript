 ...
 */
export function tagsAndCommentsListTagAssignments(
  client: SDKCore,
  request: operations.V3TagsListAssignmentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsListAssignmentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3TagsListAssignmentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsListAssignmentsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
