 ...
 */
export function tagsAndCommentsListTagOperations(
  client: SDKCore,
  request: operations.V3TagsListOperationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsListOperationsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3TagsListOperationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/tags/{tag_id}/operations")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsListOperationsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
