 ...
 */
export function tagsAndCommentsUpdateComment(
  client: SDKCore,
  request: operations.V3CommentsUpdateCommentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3CommentsUpdateCommentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CommentsUpdateCommentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateCommentInputBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3CommentsUpdateCommentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
