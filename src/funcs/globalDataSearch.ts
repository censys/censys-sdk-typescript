...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataSearchQueryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/global/search/query")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.V3GlobaldataSearchQueryResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
