 ...
 */
export function globalDataListDnsIpResolutionRanges(
  client: SDKCore,
  request: operations.V3GlobaldataDnsIpResolutionRangesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3GlobaldataDnsIpResolutionRangesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataDnsIpResolutionRangesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ip: encodeSimple("ip", payload.ip, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/v3/global/dns/resolutions/ip/{ip}/ranges")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataDnsIpResolutionRangesResponse$inboundSchema,
