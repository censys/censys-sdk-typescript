 ...
 */
export function tagsAndCommentsListComments(
  client: SDKCore,
  request: operations.V3CommentsListCommentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3CommentsListCommentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CommentsListCommentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3CommentsListCommentsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
