...
export function accountManagementGetOrganizationDetails(
  ...
  Result<
    operations.V3AccountmanagementOrgDetailsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AccountmanagementOrgDetailsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const query = encodeFormQuery({
    "include_member_counts": payload.include_member_counts,
  }, { explode: false });
  ...
  >(
    M.json(
      200,
      operations.V3AccountmanagementOrgDetailsResponse$inboundSchema,
