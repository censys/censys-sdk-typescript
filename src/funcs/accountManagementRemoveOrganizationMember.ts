...
export enum RemoveOrganizationMemberAcceptEnum {
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AccountmanagementRemoveOrgMemberRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.nil(
      204,
      operations.V3AccountmanagementRemoveOrgMemberResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
