 ...
 */
export function globalDataGetHost(
  client: SDKCore,
  request: operations.V3GlobaldataAssetHostRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3GlobaldataAssetHostResponse,
    | errors.ErrorModel
    | SDKBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataAssetHostRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GlobaldataAssetHostResponse$inboundSchema, {
