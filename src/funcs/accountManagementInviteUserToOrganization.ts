...
export enum InviteUserToOrganizationAcceptEnum {
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AccountmanagementInviteUserToOrgRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.InviteMemberInputBody, {
    explode: true,
  });
  ...
  >(
    M.nil(
      201,
      operations.V3AccountmanagementInviteUserToOrgResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
