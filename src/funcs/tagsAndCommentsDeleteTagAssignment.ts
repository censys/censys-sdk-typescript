...
export enum DeleteTagAssignmentAcceptEnum {
 ...
 */
export function tagsAndCommentsDeleteTagAssignment(
  client: SDKCore,
  ...
  Result<
    operations.V3TagsDeleteAssignmentResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3TagsDeleteAssignmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/tags/{tag_id}/assignments/{assignment_id}")(
    pathParams,
  );
  ...
  >(
    M.nil(
      204,
      operations.V3TagsDeleteAssignmentResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
