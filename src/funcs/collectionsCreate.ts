...
export function collectionsCreate(
  ...
  Result<
    operations.V3CollectionsCrudCreateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CollectionsCrudCreateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CrudCreateInputBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3CollectionsCrudCreateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
