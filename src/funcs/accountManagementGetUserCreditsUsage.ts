 ...
 */
export function accountManagementGetUserCreditsUsage(
  client: SDKCore,
  request: operations.V3AccountmanagementUserCreditsUsageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3AccountmanagementUserCreditsUsageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AccountmanagementUserCreditsUsageRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v3/accounts/users/credits/usage")();
  ...
  >(
    M.json(
      200,
      operations.V3AccountmanagementUserCreditsUsageResponse$inboundSchema,
