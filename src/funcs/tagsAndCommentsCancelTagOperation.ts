 ...
 */
export function tagsAndCommentsCancelTagOperation(
  client: SDKCore,
  request: operations.V3TagsCancelOperationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsCancelOperationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3TagsCancelOperationRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    operation_id: encodeSimple("operation_id", payload.operation_id, {
      explode: false,
  ...
  const path = pathToFunc("/v3/tags/{tag_id}/operations/{operation_id}/cancel")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsCancelOperationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
