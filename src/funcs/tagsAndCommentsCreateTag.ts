 ...
 */
export function tagsAndCommentsCreateTag(
  client: SDKCore,
  request: operations.V3TagsCreateTagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsCreateTagResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3TagsCreateTagRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateTagInputBody, {
    explode: true,
  });

  const path = pathToFunc("/v3/tags")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.V3TagsCreateTagResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(401, errors.AuthenticationError$inboundSchema),
    M.jsonErr([403, 409, 422], errors.ErrorModel$inboundSchema, {
