 ...
 */
export function tagsAndCommentsBulkCreateTagAssignments(
  client: SDKCore,
  request: operations.V3TagsBulkCreateAssignmentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsBulkCreateAssignmentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3TagsBulkCreateAssignmentsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.BulkCreateTagAssignmentsInputBody, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v3/tags/{tag_id}/assignments/bulk-create")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3TagsBulkCreateAssignmentsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
