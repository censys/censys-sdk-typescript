...
export function accountManagementGetMemberCreditUsage(
  ...
  Result<
    operations.V3AccountmanagementMemberCreditsUsageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AccountmanagementMemberCreditsUsageRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.V3AccountmanagementMemberCreditsUsageResponse$inboundSchema,
