...
export function accountManagementListOrganizationMembers(
  ...
  Result<
    operations.V3AccountmanagementListOrgMembersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AccountmanagementListOrgMembersRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.V3AccountmanagementListOrgMembersResponse$inboundSchema,
