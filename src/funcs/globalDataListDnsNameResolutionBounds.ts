 ...
 */
export function globalDataListDnsNameResolutionBounds(
  client: SDKCore,
  request: operations.V3GlobaldataDnsNameResolutionBoundRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3GlobaldataDnsNameResolutionBoundResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataDnsNameResolutionBoundRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/global/dns/resolutions/{name}/bounds")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataDnsNameResolutionBoundResponse$inboundSchema,
