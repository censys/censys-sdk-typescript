 ...
 */
export function tagsAndCommentsGetTagOperation(
  client: SDKCore,
  request: operations.V3TagsGetOperationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsGetOperationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3TagsGetOperationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/tags/{tag_id}/operations/{operation_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsGetOperationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
