...
export function collectionsSearch(
  ...
  Result<
    operations.V3CollectionsSearchQueryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CollectionsSearchQueryRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SearchQueryInputBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3CollectionsSearchQueryResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
