 ...
 */
export function tagsAndCommentsListTags(
  client: SDKCore,
  request: operations.V3TagsListTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3TagsListTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3TagsListTagsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3TagsListTagsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
