...
export function globalDataGetWebProperty(
  ...
  Result<
    operations.V3GlobaldataAssetWebpropertyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataAssetWebpropertyRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GlobaldataAssetWebpropertyResponse$inboundSchema, {
