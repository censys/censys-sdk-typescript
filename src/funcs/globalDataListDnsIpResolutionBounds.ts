...
export function globalDataListDnsIpResolutionBounds(
  ...
  Result<
    operations.V3GlobaldataDnsIpResolutionBoundResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GlobaldataDnsIpResolutionBoundRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/global/dns/resolutions/ip/{ip}/bounds")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.V3GlobaldataDnsIpResolutionBoundResponse$inboundSchema,
