...
export enum DeleteCommentAcceptEnum {
 ...
 */
export function tagsAndCommentsDeleteComment(
  client: SDKCore,
  request: operations.V3CommentsDeleteCommentRequest,
  options?: RequestOptions & { acceptHeaderOverride?: DeleteCommentAcceptEnum },
): APIPromise<
  Result<
    operations.V3CommentsDeleteCommentResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CommentsDeleteCommentRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    comment_id: encodeSimple("comment_id", payload.comment_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/v3/comments/{comment_id}")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.V3CommentsDeleteCommentResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
