...
export function collectionsGet(
  ...
  Result<
    operations.V3CollectionsCrudGetResponse,
    | errors.ErrorModel
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CollectionsCrudGetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.V3CollectionsCrudGetResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
