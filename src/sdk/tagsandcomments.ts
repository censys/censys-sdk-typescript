...
import { tagsAndCommentsBulkCreateTagAssignments } from "../funcs/tagsAndCommentsBulkCreateTagAssignments.js";
import { tagsAndCommentsBulkDeleteTagAssignments } from "../funcs/tagsAndCommentsBulkDeleteTagAssignments.js";
import { tagsAndCommentsCancelTagOperation } from "../funcs/tagsAndCommentsCancelTagOperation.js";
...
export class TagsAndComments extends ClientSDK {
   ...
   */
  async bulkCreateTagAssignments(
    request: operations.V3TagsBulkCreateAssignmentsRequest,
    options?: RequestOptions,
  ): Promise<operations.V3TagsBulkCreateAssignmentsResponse> {
    return unwrapAsync(tagsAndCommentsBulkCreateTagAssignments(
      this,
      request,
      options,
    ));
   ...
   */
  async bulkDeleteTagAssignments(
    request: operations.V3TagsBulkDeleteAssignmentsRequest,
    options?: RequestOptions,
  ): Promise<operations.V3TagsBulkDeleteAssignmentsResponse> {
    return unwrapAsync(tagsAndCommentsBulkDeleteTagAssignments(
      this,
      request,
      options,
    ));
   ...
   */
  async listTagOperations(
    request: operations.V3TagsListOperationsRequest,
    options?: RequestOptions,
   ...
   */
  async cancelTagOperation(
    request: operations.V3TagsCancelOperationRequest,
    options?: RequestOptions,
  ): Promise<operations.V3TagsCancelOperationResponse> {
    return unwrapAsync(tagsAndCommentsCancelTagOperation(
      this,
      request,
      options,
    ));
