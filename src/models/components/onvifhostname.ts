...
export type OnvifHostname = {
  fromDhcp?: boolean | undefined;
  name?: string | undefined;
};

/** @internal */
export const OnvifHostname$inboundSchema: z.ZodType<
  OnvifHostname,
  z.ZodTypeDef,
  unknown
> = z.object({
  from_dhcp: z.boolean().optional(),
...
export function onvifHostnameFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => OnvifHostname$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OnvifHostname' from JSON`,
  );
}
