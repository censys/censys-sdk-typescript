...
export type Ja4TScanScan = {
  fingerprint?: string | undefined;
  scanTime?: string | undefined;
};

/** @internal */
export const Ja4TScanScan$inboundSchema: z.ZodType<
  Ja4TScanScan,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function ja4TScanScanFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => Ja4TScanScan$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Ja4TScanScan' from JSON`,
  );
}
